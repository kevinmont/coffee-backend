...
/**
 * Clase {@link UserDAOImpl} encargada de realizar el acceso a datos para un
 * usuario y que implementa {@code UserDAO}
 * 
 * @author mont
 */
public class UserDAOImpl extends AbstractDAO implements UserDAO {
	...
	@Override
	public UserDTO getUserByNickName(String user) throws BadRequest {
		...
		if (!user.isEmpty()) {
			...
			if(userRecover != null)
				return userRecover;
			throw new BadRequest("No existe algun usuario "+ user); 
		}
		throw new BadRequest("parametro user es nulo");
	}
